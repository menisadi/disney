...
```{r}
cor.test(movies$`IMDb Rating`, movies$`Runtime (mins)`)
t.test(`IMDb Rating` ~ is_comedy, data = movies)
t.test(`IMDb Rating` ~ is_musical, data = movies)
